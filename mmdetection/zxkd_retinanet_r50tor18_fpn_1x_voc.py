...
model = dict(
    ...
    bbox_head=dict(
        ...
        box_kd_loss=dict(loss_weight=1.0, type='L1Loss'),
        cls_kd_loss=dict(
            T=10,
            loss_weight=1.0,
            reduction='mean',
    ...
    neck=dict(
        ...
        type='FPN'),
    teacher_ckpt=
    '/home/zx/rgbx-distillation/code/mmdetection-main/ckpts/retinanet_r50_fpn_1x_voc0712_20200617-47cbdd0e.pth',
    teacher_config=
    '/home/zx/rgbx-distillation/code/mmdetection-main/configs/zx_distillation/retinanet_r50_fpn_1x_voc.py',
    test_cfg=dict(
        max_per_img=100,
        min_bbox_size=0,
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        '/home/zx/rgbx-distillation/datasets/detection/VOC_mmdetection/VOCdevkit/',
        pipeline=[
